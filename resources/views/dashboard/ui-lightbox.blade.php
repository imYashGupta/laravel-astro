...
@section('breadcrumb')
<h3 class="page-title">Lightbox</h1>
@endsection
                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <div class="zoom-gallery">
                                                <a class="pull-left" href="{{ URL::asset('assets/images/small/img-3.jpg') }}" title="Project 1"><img src="assets/images/small/img-3.jpg" width="275"></a>
                                                <a class="pull-left" href="{{ URL::asset('assets/images/small/img-7.jpg') }}" title="Project 2"><img src="assets/images/small/img-7.jpg" width="275"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
