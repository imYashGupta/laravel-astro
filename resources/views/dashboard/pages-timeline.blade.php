...
@section('breadcrumb')
<h3 class="page-title">Timeline</h1>
@endsection
                                            ...
                                            <section id="cd-timeline" class="cd-container">
                                                ...
                                                <div class="cd-timeline-block">
                                                    ...
                                                    <div class="cd-timeline-content">
                                                        ...
                                                        <img src="{{ URL::asset('assets/images/small/img-1.jpg') }}" alt="" class="rounded" style="width: 120px;">
                                                        <img src="{{ URL::asset('assets/images/small/img-2.jpg') }}" alt="" class="rounded" style="width: 120px;">
