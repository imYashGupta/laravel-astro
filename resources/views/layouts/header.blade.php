...
<div class="sidebar-inner slimscrollleft">
    <div id="sidebar-menu">
        <ul>
            ...
            <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-border-all"></i><span> Products <span class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
            ...
            <li>
                <a href="{{route("order.index")}}" class="waves-effect"><i class="mdi mdi-cart-outline"></i><span> Orders </span></a>
            </li>
            <li>
            ...
            <li>
                <a href="{{route("support-tickets.index")}}" class="waves-effect"><i class="mdi mdi-ticket-account"></i><span>Support Ticket</span></a>
            </li>
            <li>
                <a href="{{route("enquiries.index")}}" class="waves-effect"><i class="mdi mdi-email"></i><span>Enquiries</span></a>
            </li>
            <li>
