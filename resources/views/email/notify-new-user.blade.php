...
<body bgcolor="#E8ECF1">
	...
	<table bgcolor="#E8ECF1" role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0"
								...
								<tr>
									<td style="padding: 20px;">
										<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td
													style="padding-bottom: 15px; font-family: 'Source Sans Pro', sans-serif; font-size: 26px; line-height: 34px; color: #1B2733;">
													Hi , {{$user->firstname}}
												</td>
											</tr>
											<tr>
												<td
													...
													Welcome to <a
														href="{{ env('APP_URL') }}"
														style="color: #000000;">{{ env('APP_NAME') }}</a> <br>
													Please use this details to access your account.
													<p>
